...
public class RouteContractSnapshotTests : IClassFixture<NoMercyApiFactory>
{
    ...
    [
        ...
        "DELETE api/v{version:apiVersion}/dashboard/plugins/{id:guid}/consent [Plugin.RevokeConsent]",
        ...
        "POST api/v{version:apiVersion}/dashboard/plugins/repositories/{pluginId:guid}/install [PluginRepository.Install]",
        ...
        "POST api/v{version:apiVersion}/dashboard/plugins/{id:guid}/grants [Plugin.ResolveGrant]",
