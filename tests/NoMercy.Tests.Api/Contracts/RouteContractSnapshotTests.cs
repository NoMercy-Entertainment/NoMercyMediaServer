...
public class RouteContractSnapshotTests : IClassFixture<NoMercyApiFactory>
{
    ...
    [
        ...
        "DELETE api/v{version:apiVersion}/dashboard/plugins/{id:ulid} [Plugin.Uninstall]",
        "DELETE api/v{version:apiVersion}/dashboard/plugins/repositories/{name} [PluginRepository.Remove]",
        "DELETE api/v{version:apiVersion}/dashboard/plugins/{id:ulid}/consent [Plugin.RevokeConsent]",
        "DELETE api/v{version:apiVersion}/dashboard/reclaim/items/{id} [Reclaim.DeleteItem]",
        "DELETE api/v{version:apiVersion}/dashboard/security/bans/{address} [Security.Unban]",
        ...
        "GET api/v{version:apiVersion}/anime/demographics [AnimeDemographics.Demographics]",
        "GET api/v{version:apiVersion}/anime/demographics/{demographicId} [AnimeDemographics.Demographic]",
        "GET api/v{version:apiVersion}/anime/seasons [AnimeSeasons.Seasons]",
        "GET api/v{version:apiVersion}/anime/seasons/{seasonId} [AnimeSeasons.Season]",
        "GET api/v{version:apiVersion}/anime/themes [AnimeThemes.Themes]",
        "GET api/v{version:apiVersion}/anime/themes/{themeId} [AnimeThemes.Theme]",
        ...
        "GET api/v{version:apiVersion}/dashboard/plugins/grants/pending [Plugin.PendingGrants]",
        "GET api/v{version:apiVersion}/dashboard/plugins/{id:ulid} [Plugin.Show]",
        ...
        "GET api/v{version:apiVersion}/dashboard/security/bans [Security.Bans]",
        "GET api/v{version:apiVersion}/dashboard/security/blocklist-url [Security.BlocklistUrl]",
        "GET api/v{version:apiVersion}/dashboard/security/settings [Security.Settings]",
        ...
        "GET api/v{version:apiVersion}/plugins/{id:ulid}/translations/{locale} [PluginUi.Translations]",
        "GET api/v{version:apiVersion}/plugins/{id:ulid}/view [PluginUi.View]",
        ...
        "GET api/v{version:apiVersion}/setup/navigation [Setup.Navigation]",
        ...
        "POST api/v{version:apiVersion}/dashboard/optical/onboarding/{drivePath}/confirm [DiscOnboarding.ConfirmOnboarding]",
        "POST api/v{version:apiVersion}/dashboard/optical/onboarding/{drivePath}/start [DiscOnboarding.StartOnboarding]",
        ...
        "POST api/v{version:apiVersion}/dashboard/plugins/repositories [PluginRepository.Add]",
        "POST api/v{version:apiVersion}/dashboard/plugins/repositories/refresh [PluginRepository.Refresh]",
        "POST api/v{version:apiVersion}/dashboard/plugins/repositories/{pluginId:ulid}/install [PluginRepository.Install]",
        "POST api/v{version:apiVersion}/dashboard/plugins/{id:ulid}/consent [Plugin.Consent]",
        ...
        "POST api/v{version:apiVersion}/dashboard/security/blocklist-url/rotate [Security.RotateBlocklistUrl]",
        ...
        "POST api/v{version:apiVersion}/specials/seed [Special.Seed]",
        "POST api/v{version:apiVersion}/specials/{id:ulid}/like [Special.Like]",
        "POST api/v{version:apiVersion}/specials/{id:ulid}/rescan [Special.Rescan]",
