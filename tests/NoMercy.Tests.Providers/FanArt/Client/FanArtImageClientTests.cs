...
public class FanArtImageClientTests
{
    ...
    public void Download_StateMachine_DoesNotCallReadAsStreamAsync()
    {
        ...
        Assert.False(
            ...
            userMessage: "PROV-H10 regression: Download should NOT call ReadAsStreamAsync. "
    ...
    public void Download_StateMachine_CallsReadAsByteArrayAsync()
    {
        ...
        Assert.True(
            ...
            userMessage: "PROV-H10: Download must call ReadAsByteArrayAsync to buffer the content once."
        );
    }
    ...
    public void Download_StateMachine_ImageLoadUsesByteArrayOverload()
    {
        ...
        Assert.True(
            ...
            userMessage: "PROV-H10: Image.Load should use the byte[] overload, not Stream, "
