...
public class HlsCodecsStringBuilderTests
{
    ...
    {
        HlsCodecsStringBuilder.ForHevc("main", null, false).Should().Be("hvc1.1.6.L93.B0");
        HlsCodecsStringBuilder.ForHevc("main", null, true).Should().Be("hvc1.2.4.L120.B0");
    }
    ...
    {
        HlsCodecsStringBuilder.ForAv1(null, false).Should().Be("av01.0.08M.08");
        HlsCodecsStringBuilder.ForAv1(null, true).Should().Be("av01.0.15M.10");
    }
    ...
    {
        HlsCodecsStringBuilder.ForHevc("main", level, false).Should().Be(expected);
    }
    ...
    public void ForHevc_UnknownLevel_DefaultsByBitDepth()
    {
        ...
        HlsCodecsStringBuilder
            .ForHevc("main", "weird", false)
            .Should()
            .Be("hvc1.1.6.L93.B0");
        HlsCodecsStringBuilder
            .ForHevc("main", "weird", true)
            .Should()
            .Be("hvc1.2.4.L120.B0");
    }
    ...
    public void ForAv1_UnknownLevel_Defaults_AndBitDepthIndependent()
    {
        ...
        HlsCodecsStringBuilder.ForAv1("garbage", false).Should().Be("av01.0.08M.08");
        HlsCodecsStringBuilder.ForAv1("garbage", true).Should().Be("av01.0.08M.10");
    }
    ...
    public void ForHevc_4KHdr_ClampsLevelUpFromPresetDefault()
    {
        ...
        HlsCodecsStringBuilder
            .ForHevc("main10", "4.0", true, 3840, 2160, 23.976)
            .Should()
            .Be("hvc1.2.4.L150.B0");

        HlsCodecsStringBuilder
            .ForHevc("main10", null, true, 3840, 2160, 23.976)
            .Should()
            .Be("hvc1.2.4.L150.B0");
    }
    ...
    public void ForHevc_4KHighFrameRate_NeedsLevel5_1()
    {
        ...
        HlsCodecsStringBuilder
            .ForHevc("main10", "4.0", true, 3840, 2160, 60)
            .Should()
            .Be("hvc1.2.4.L153.B0");
    }
    ...
    public void ForHevc_1080p_KeepsPresetLevelWhenResolutionAllows()
    {
        ...
        HlsCodecsStringBuilder
            .ForHevc("main10", "4.0", true, 1920, 1080, 23.976)
            .Should()
            .Be("hvc1.2.4.L120.B0");
    }
    ...
    public void ForHevc_PresetAboveFloor_IsNotLowered()
    {
        ...
        HlsCodecsStringBuilder
            .ForHevc("main10", "5.2", true, 1920, 1080, 23.976)
            .Should()
            .Be("hvc1.2.4.L156.B0");
    }
    ...
    public void ForH264_4K_ClampsToLevel5_1()
    {
        ...
        HlsCodecsStringBuilder
            .ForH264("high", "4.0", 3840, 2160, 23.976)
            .Should()
            .Be("avc1.640033");
    }
    ...
    public void ForAv1_4K8Bit_ClampsToLevel5_0()
    {
        ...
        HlsCodecsStringBuilder
            .ForAv1("4.0", false, 3840, 2160, 23.976)
            .Should()
            .Be("av01.0.12M.08");
    }
    ...
    public void VideoCodecString_NoResolution_LeavesLevelUnclamped()
    {
        ...
        HlsCodecsStringBuilder
            .VideoCodecString("hevc_nvenc", "main10", "4.0", true)
            .Should()
            .Be("hvc1.2.4.L120.B0");
    }
}
