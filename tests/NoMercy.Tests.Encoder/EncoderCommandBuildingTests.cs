...
public class EncoderCommandBuildingTests : IDisposable
{
    ...
    [InlineData("h264_amf", typeof(X264))]
    [InlineData("h264_qsv", typeof(X264))]
    [InlineData("h264_videotoolbox", typeof(X264))]
    [InlineData("libx265", typeof(X265))]
    [InlineData("hevc_nvenc", typeof(X265))]
    [InlineData("hevc_amf", typeof(X265))]
    [InlineData("hevc_qsv", typeof(X265))]
    [InlineData("hevc_videotoolbox", typeof(X265))]
    [InlineData("vp9", typeof(Vp9))]
    [InlineData("libvpx-vp9", typeof(Vp9))]
    [InlineData("vp9_nvenc", typeof(Vp9))]
    [InlineData("vp9_amf", typeof(Vp9))]
    [InlineData("vp9_qsv", typeof(Vp9))]
    [InlineData("vp9_videotoolbox", typeof(Vp9))]
    [InlineData("librav1e", typeof(Av1))]
    [InlineData("av1_nvenc", typeof(Av1))]
    [InlineData("av1_amf", typeof(Av1))]
    [InlineData("av1_qsv", typeof(Av1))]
    [InlineData("av1_videotoolbox", typeof(Av1))]
