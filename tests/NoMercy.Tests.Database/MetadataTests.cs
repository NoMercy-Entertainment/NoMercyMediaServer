...
public class MetadataTests
{
    ...
    public async Task CalculateTotalSize_ReturnsCorrectSize()
    {
        ...
        {
            Id = new(),
            Video = [new() { FileSize = 500 }, new() { FileSize = 700 }],
            Audio = [new() { FileSize = 300 }, new() { FileSize = 400 }],
            Subtitles = [new() { FileSize = 50 }, new() { FileSize = 70 }],
            Previews =
            [
                new() { ImageFileSize = 30, TimeFileSize = 20 },
                new() { ImageFileSize = 40, TimeFileSize = 25 },
            ],
            Fonts = [new() { FileSize = 15 }, new() { FileSize = 25 }],
