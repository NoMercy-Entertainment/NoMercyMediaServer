...
{
    public static readonly Guid UserId = Guid.Parse(input: "37d03e60-7b0a-4246-a85b-a5618966a383");
    public static readonly Guid OtherUserId = Guid.Parse(input: "a1b2c3d4-e5f6-7890-abcd-ef1234567890");
    ...
    public static readonly Ulid EncodingPresetId = Ulid.NewUlid();
}
