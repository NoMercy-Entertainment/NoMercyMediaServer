...
public class MusicGenreRepository(MediaContext context) : IMusicGenreRepository
{
    ...
    {
        return context
            .MusicGenreReleaseGroup.Upsert(genreReleaseGroup)
    ...
    {
        return context
            .ArtistMusicGenre.UpsertRange(genreArtists)
    ...
    {
        return context
            .AlbumMusicGenre.UpsertRange(genreReleases)
    ...
    {
        return context
            .MusicGenreTrack.UpsertRange(genreRecordings)
