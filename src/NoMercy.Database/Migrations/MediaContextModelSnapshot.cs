...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NoMercy.Database.Models.Media.Image", b =>
                {
                    ...
                    b.HasIndex("AlbumId")
                        .HasDatabaseName("IX_Images_AlbumId")
                        .HasFilter("AlbumId IS NOT NULL");

                    b.HasIndex("ArtistId")
                        .HasDatabaseName("IX_Images_ArtistId")
                    ...
                    b.HasIndex("PersonId")
                        .HasDatabaseName("IX_Images_PersonId")
                        .HasFilter("PersonId IS NOT NULL");

                    b.HasIndex("SeasonId")
                        .HasDatabaseName("IX_Images_SeasonId")
                        .HasFilter("SeasonId IS NOT NULL");

                    b.HasIndex("TrackId")
                        .HasDatabaseName("IX_Images_TrackId")
                        .HasFilter("TrackId IS NOT NULL");

                    b.HasIndex("TvId")
                        .HasDatabaseName("IX_Images_TvId")
            ...
            modelBuilder.Entity("NoMercy.Database.Models.Music.TrackAudioAnalysis", b =>
                {
                    b.Property<Guid>("TrackId")
                        .HasColumnType("TEXT");
                    ...
                    b.Property<double?>("BeatIntervalMs")
                        .HasColumnType("REAL");

                    b.Property<int?>("BeatOffsetMs")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<int?>("IntroEndMs")
                        .HasColumnType("INTEGER");

                    b.Property<string>("KeyCamelot")
                        .HasMaxLength(4)
                        .HasColumnType("TEXT");

                    b.Property<double?>("KeyConfidence")
                        .HasColumnType("REAL");
            ...
            modelBuilder.Entity("NoMercy.Database.Models.Playlists.PlaylistItem", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("EpisodeId")
                        .HasDatabaseName("IX_PlaylistItems_EpisodeId")
                        .HasFilter("EpisodeId IS NOT NULL");

                    b.HasIndex("MovieId")
                        .HasDatabaseName("IX_PlaylistItems_MovieId")
                        .HasFilter("MovieId IS NOT NULL");

                    b.HasIndex("SpecialId")
                        .HasDatabaseName("IX_PlaylistItems_SpecialId")
                        .HasFilter("SpecialId IS NOT NULL");

                    b.HasIndex("TvId")
                        .HasDatabaseName("IX_PlaylistItems_TvId")
                        .HasFilter("TvId IS NOT NULL");

                    b.HasIndex("UserPlaylistId", "Order");

                    b.ToTable("PlaylistItems", t =>
                        {
                            t.HasTrigger("update_PlaylistItems_updated_at");
                        });
                });

            modelBuilder.Entity("NoMercy.Database.Models.Playlists.UserPlaylist", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("UserPlaylists", t =>
                        {
                            t.HasTrigger("update_UserPlaylists_updated_at");
                        });
                });
            ...
            modelBuilder.Entity("NoMercy.Database.Models.Security.IpBan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("IpBans", t =>
                        {
                            t.HasTrigger("update_IpBans_updated_at");
                        });
                });
            ...
            modelBuilder.Entity("NoMercy.Database.Models.Users.Device", b =>
                {
                    ...
                    b.Property<DateTime?>("MdnsSeenAt")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("NoMercy.Database.Models.Users.UserData", b =>
                {
                    ...
                    b.Property<bool>("RemovedFromContinueWatching")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("NoMercy.Database.Models.Media.EncodingPresetFolder", b =>
                {
                    b.HasOne("NoMercy.Database.Models.Libraries.Folder", "Folder")
                        .WithMany("EncodingPresetFolders")
                        .HasForeignKey("FolderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("NoMercy.Database.Models.Playlists.PlaylistItem", b =>
                {
                    ...
                    b.HasOne("NoMercy.Database.Models.Playlists.UserPlaylist", "UserPlaylist")
                        .WithMany()
            ...
            modelBuilder.Entity("NoMercy.Database.Models.Users.Device", b =>
                {
                    b.HasOne("NoMercy.Database.Models.Users.User", "OwnerUser")
                        .WithMany()
