...
public class Stream
{
    ...
    [JsonProperty("ts_packetsize")]
    public long TsPacketsize { get; set; }
    ...
    public Dictionary<string, long> Disposition { get; set; } = new();
...
public class SideDataList
{
    ...
    [JsonProperty("vbv_delay")]
    public long VbvDelay { get; set; }
}
