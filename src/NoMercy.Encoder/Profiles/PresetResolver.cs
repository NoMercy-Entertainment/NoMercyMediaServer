...
public interface IPresetResolver
{
    ...
    /// </summary>
    EncodingProfile Resolve(PresetResolveRequest request, IPresetLookup lookup);
}

public class PresetResolver : IPresetResolver
{
    private const int MaxInheritanceDepth = 10;

    public EncodingProfile Resolve(PresetResolveRequest request, IPresetLookup lookup)
    {
