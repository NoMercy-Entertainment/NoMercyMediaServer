...
public class WebM : BaseContainer
{
    public override ContainerDto ContainerDto =>
        AvailableContainers.First(c => c.Name == VideoContainers.Webm);
    ...
    public override CodecDto[] AvailableCodecs => [VideoCodecs.Vp9, VideoCodecs.Vp9Nvenc];

    public override CodecDto[] AvailableVideoCodecs => [VideoCodecs.Vp9, VideoCodecs.Vp9Nvenc];

    public override CodecDto[] AvailableAudioCodecs => [AudioCodecs.Opus, AudioCodecs.Vorbis];
