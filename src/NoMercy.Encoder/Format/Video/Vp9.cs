...
public class Vp9 : BaseVideo
{
    ...
    protected internal override string[] AvailableContainers =>
        [VideoContainers.Mkv, VideoContainers.Webm, VideoContainers.Flv, VideoContainers.Hls];
    ...
    public override string[] AvailableProfiles =>
        [
            VideoProfiles.Unknown,
            VideoProfiles.Profile0,
            VideoProfiles.Profile1,
            VideoProfiles.Profile2,
            VideoProfiles.Profile3,
        ];
    ...
    public override string[] AvailableTune =>
        [VideoTunes.Hq, VideoTunes.Li, VideoTunes.Ull, VideoTunes.Lossless];
