...
public class FfprobeSourceDataChapter
{
    ...
    [JsonProperty("tags")] public FfprobeSourceDataChapterTags Tags { get; set; }
}
...
public class FfprobeSourceDataFormat
{
    ...
    [JsonProperty("tags")] public FfprobeSourceDataFormatTags Tags { get; set; }
}
...
public class FfprobeSourceDataStream
{
    ...
    [JsonProperty("disposition")] public Dictionary<string, int> Disposition { get; set; }
    [JsonProperty("tags")] public FfprobeSourceDataStreamTags Tags { get; set; }
