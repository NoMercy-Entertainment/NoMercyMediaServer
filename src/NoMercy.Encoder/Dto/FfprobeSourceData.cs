...
public class FfprobeSourceData
{
    ...
    public FfprobeSourceDataStream[] Streams { get; set; } = [];

    [JsonProperty("chapters")]
    public FfprobeSourceDataChapter[] Chapters { get; set; } = [];
...
public class FfprobeSourceDataChapter
{
    ...
    [JsonProperty("tags")]
    public FfprobeSourceDataChapterTags Tags { get; set; } = new();
}
...
public class FfprobeSourceDataFormat
{
    ...
    public long NbStreamGroups { get; set; }
...
public class FfprobeSourceDataStream
{
    ...
    {
        get => _codecType == CodecType.Video && CodecName == "mjpeg" ? CodecType.Image : _codecType;
    ...
    [JsonProperty("view_ids_available")]
    public string? ViewIdsAvailable { get; set; }

    [JsonProperty("view_pos_available")]
    public string? ViewPosAvailable { get; set; }
    ...
    public Dictionary<string, int> Disposition { get; set; } = new();
...
public class FfprobeSourceDataStreamTags
{
    ...
    private void OnDeserialized(StreamingContext context)
    {
        ...
        {
            string? numberBytesKey = _additionalData.Keys.FirstOrDefault(key =>
                key.StartsWith("NUMBER_OF_BYTES", StringComparison.OrdinalIgnoreCase)
            );

            if (
                !string.IsNullOrEmpty(numberBytesKey)
...
public class FfprobeSourceMusicBrainz
{
    ...
    [JsonProperty("release_artist_id")]
    public Guid ReleaseArtistId { get; set; }

    [JsonProperty("recording_id")]
    public Guid RecordingId { get; set; }

    [JsonProperty("release_track_id")]
