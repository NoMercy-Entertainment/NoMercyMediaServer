...
public static class KnownDegenerateDeviceIds
{
    ...
    {
        Guid.Parse("75f26c31-97d3-e6d4-eb13-65fbe4bb799e"),
        Guid.Parse("0460d8e2-2a41-eda4-791e-af3284eddac0"),
        Guid.Parse("b32ec49d-e0da-0089-ec7b-06ff222123a2"),
        Guid.Parse("41d49f20-56d5-ce73-6c37-15e49008b842"),
        Guid.Parse("8c380931-2ce8-5c7f-e0a8-1b834c71efff"),
        Guid.Parse("a1cfce7c-7af9-eb46-e304-03fab52bdbbd"),
        Guid.Parse("cf6376ca-b150-cb86-00cf-01d1a7769add"),
        Guid.Parse("55bb248e-f55a-7840-85fa-bcfd8cb088b3"),
    };
