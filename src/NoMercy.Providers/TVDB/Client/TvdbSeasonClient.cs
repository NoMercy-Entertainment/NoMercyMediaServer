...
public class TvdbSeasonClient : TvdbBaseClient
{
    ...
    {
        return Get<TvdbSeasonResponse>(url: "seasons/" + Id, priority: priority);
    }

    public Task<TvdbSeasonExtendedResponse?> Extended(bool? priority = false)
    {
        return Get<TvdbSeasonExtendedResponse>(url: "seasons/" + Id + "/extended", priority: priority);
    }

    public Task<TvdbSeasonExtendedResponse?> WithAllAppends(bool? priority = false)
    {
        return Extended(priority: priority);
    }
    ...
    {
        return Get<TvdbSeasonTypesResponse>(url: "seasons/types", priority: priority);
    }
}
