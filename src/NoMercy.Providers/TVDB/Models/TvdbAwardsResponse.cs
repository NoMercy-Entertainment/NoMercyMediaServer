...
public class TvdbAwardExtendedData
{
    ...
    public List<TvdbAwardCategoryData> Categories { get; set; } = [];
...
public class TvdbAwardCategoryData
{
    ...
    [JsonProperty("award")]
    public TvdbStatus Award { get; set; } = new();
...
public class TvdbNominee
{
    ...
    public TvdbCharacter? Character { get; set; }
}
...
public class TvdbMovie
{
    ...
    [JsonProperty("status")]
    public TvdbAwardStatus? TvdbAwardStatus { get; set; }
