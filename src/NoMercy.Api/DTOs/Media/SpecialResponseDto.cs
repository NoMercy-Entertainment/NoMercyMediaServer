...
public record SpecialResponseDto
{
    ...
    public static readonly Func<
        ...
        string,
        Task<Special?>
    > GetSpecial = EF.CompileAsyncQuery(
        (MediaContext mediaContext, Guid userId, Ulid id, string language, string country) =>
            mediaContext
    ...
    > GetSpecialMovies = EF.CompileAsyncQuery(
        (
            ...
            mediaContext
                ...
                .Include(tv => tv.MovieUser.Where(movieUser => movieUser.UserId.Equals(userId)))
                ...
                .Include(movie => movie.Cast.OrderBy(castTv => castTv.Role.Order))
    ...
    public static readonly Func<
        ...
        string,
        IAsyncEnumerable<Tv>
    > GetSpecialTvs = EF.CompileAsyncQuery(
        (
            MediaContext mediaContext,
            Guid userId,
            IEnumerable<int> ids,
            ...
            mediaContext
                ...
                .Include(tv => tv.TvUser.Where(tvUser => tvUser.UserId.Equals(userId)))
                ...
                .Include(tv => tv.Cast.OrderBy(castTv => castTv.Role.Order))
                    .ThenInclude(castTv => castTv.Person)
                .Include(tv => tv.Cast.OrderBy(castTv => castTv.Role.Order))
                    .ThenInclude(castTv => castTv.Role)
                .Include(tv => tv.Crew)
