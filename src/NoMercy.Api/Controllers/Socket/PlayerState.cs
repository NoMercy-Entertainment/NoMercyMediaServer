...
public class Disallows {
    [JsonProperty("previous", NullValueHandling = NullValueHandling.Ignore)] public bool? Previous { get; set; }
    [JsonProperty("resuming", NullValueHandling = NullValueHandling.Ignore)] public bool? Resuming { get; set; }
    [JsonProperty("pausing", NullValueHandling = NullValueHandling.Ignore)] public bool? Pausing { get; set; }
    [JsonProperty("toggling_repeat_context", NullValueHandling = NullValueHandling.Ignore)] public bool? TogglingRepeatContext { get; set; }
    [JsonProperty("toggling_repeat_track", NullValueHandling = NullValueHandling.Ignore)] public bool? TogglingRepeatTrack { get; set; }
    [JsonProperty("toggling_shuffle", NullValueHandling = NullValueHandling.Ignore)] public bool? TogglingShuffle { get; set; }
}
