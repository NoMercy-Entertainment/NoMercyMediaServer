...
public class HomeController : BaseController
{
    ...
    public async Task<IActionResult> HasTrailer(int id, string trailerId)
    {
        ...
        await System.IO.File.WriteAllTextAsync(Path.Combine(folder, "info.json"), result.StandardOutput);
    ...
    public async Task<IActionResult> Trailer(int id, string trailerId)
    {
        ...
        Logger.Encoder(sb.ToString(), LogEventLevel.Debug);
        
        _ = Task.Run(async () => await Shell.ExecAsync(AppFiles.YtdlpPath, sb.ToString(), new()
        {
